...
| 7 | Backtesting & Paper Trading | not started — realistic options slippage (`../PLAN.md` §1.2), MarketClock/DataSourceRouter 24/7 replay (§1.4), **and the Prediction-Labeled Trade Tables lab (§9, adopted 2026-07-23): WIN / deliberate-LOSS / UNCERTAIN tables with immutable PredictionRecords + calibration scoreboard — the paper engine is an experiment allocator, not one portfolio** | — |
