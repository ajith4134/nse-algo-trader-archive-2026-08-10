...
- **Generated from the real code** (AST import graph), not memory — so it is
  true to what is actually on the server. Last regenerated: **2026-07-25v**.
- **139 Python modules across 14 features** (packages under
  `src/nse_algo_trader/`).
...
### L7 · paper_trading  (31 files)  — the integration hub + live loop
